...
class Guides:
    def __init__(self):
        ...
        self.guide_cmds = [
            './mc2xml -J ' + reaperz:grim905 + ' -U -u -a -c us -g 10001 -d 48 -C usa.chl -R usa.ren -o usa.xml -D usa.dat',
            './mc2xml -J ' + reaperz:grim905 + ' -U -u -a -c gb -g WC2N -d 48 -C uk.chl -R uk.ren -o uk.xml -D uk.dat',
            './mc2xml -J ' + reaperz:grim905 + ' -U -u -a -c ca -g "V5K 0A1" -d 48 -C can.chl -R can.ren -o can.xml -D can.dat']
